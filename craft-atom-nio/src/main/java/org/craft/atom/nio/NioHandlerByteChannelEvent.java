 ...
 */
public class NioHandlerByteChannelEvent extends NioByteChannelEvent {
	
	private static final Log LOG = LogFactory.getLog(NioHandlerByteChannelEvent.class);
	...
	NioHandlerByteChannelEvent(ChannelEventType type, NioByteChannel channel, IoHandler handler) {
        this(type, channel, handler, null);
    }
	
	NioHandlerByteChannelEvent(ChannelEventType type, NioByteChannel channel, IoHandler handler, Object parameter) {
		super(type, channel);
