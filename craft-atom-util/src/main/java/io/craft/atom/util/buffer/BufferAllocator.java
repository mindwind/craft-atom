...
/**
 * Allocates {@link AdaptiveByteBuffer}s and manages them.  Please implement this
...
public interface BufferAllocator {
     ...
     */
    AdaptiveByteBuffer allocate(int capacity, boolean direct);
     ...
     */
    AdaptiveByteBuffer wrap(ByteBuffer nioBuffer);
