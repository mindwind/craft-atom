...
import static io.craft.atom.protocol.http.HttpConstants.COLON;
import static io.craft.atom.protocol.http.HttpConstants.CONTENT_ENCODING_DEFLATE;
import static io.craft.atom.protocol.http.HttpConstants.CONTENT_ENCODING_GZIP;
import static io.craft.atom.protocol.http.HttpConstants.CONTENT_ENCODING_IDENTITY;
import static io.craft.atom.protocol.http.HttpConstants.CR;
import static io.craft.atom.protocol.http.HttpConstants.EQUAL_SIGN;
import static io.craft.atom.protocol.http.HttpConstants.HT;
import static io.craft.atom.protocol.http.HttpConstants.LF;
import static io.craft.atom.protocol.http.HttpConstants.NUL;
...
import static io.craft.atom.protocol.http.HttpConstants.TRANSFER_ENCODING_CHUNKED;
